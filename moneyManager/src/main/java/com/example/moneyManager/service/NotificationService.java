...
public class NotificationService {
    ...
    @Value("${money.manager.frontend.url}") // ✅ Will now inject property correctly
    ...
    public void sendDailyExpenseSummary(){
        ...
        List<ProfileEntity> profiles = profileRepository.findAll();
        for(ProfileEntity profile:profiles){
           List<ExpenseDto> todayExpenses= expenseService.getExpensesForUserDate(profile.getId(), LocalDate.now());
